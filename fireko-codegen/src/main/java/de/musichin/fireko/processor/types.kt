...
internal val FIREBASE_COLLECTION_REFERENCE =
...
internal val FIREBASE_SET_OPTIONS =
    ClassName("com.google.firebase.firestore", "SetOptions")
internal val FIREBASE_EVENT_LISTENER =
    ClassName("com.google.firebase.firestore", "EventListener")
internal val FIREBASE_METADATA_CHANGES =
    ClassName("com.google.firebase.firestore", "MetadataChanges")
internal val FIREBASE_FIRESTORE_EXCEPTION =
    ClassName("com.google.firebase.firestore", "FirebaseFirestoreException")
internal val FIREBASE_TASK =
    ClassName("com.google.android.gms.tasks", "Task")
internal val FIREBASE_TASKS =
    ClassName("com.google.android.gms.tasks", "Tasks")
